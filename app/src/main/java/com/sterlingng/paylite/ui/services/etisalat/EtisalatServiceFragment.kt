package com.sterlingng.paylite.ui.services.etisalat
...
class EtisalatServiceFragment : BaseFragment(), EtisalatServiceMvpView, FilterBottomSheetFragment.OnFilterItemSelected {

    @Inject
    lateinit var mPresenter: EtisalatServiceMvpContract<EtisalatServiceMvpView>
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(R.layout.fragment_etisalat_service, container, false)
    ...
    companion object {
        ...
        fun newInstance(): EtisalatServiceFragment {
            val fragment = EtisalatServiceFragment()
            val args = Bundle()
