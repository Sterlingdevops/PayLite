package com.sterlingng.paylite.util
...
class RxSchedulersOverrideRule : TestRule {
    ...
    val mRxAndroidSchedulersHook = Function<Callable<Scheduler>, Scheduler> { scheduler }

    val mRxJavaImmediateScheduler = Function<Scheduler, Scheduler> { scheduler }
